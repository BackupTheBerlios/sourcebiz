...
#
# This file contains the form for adding products of an enterprise
#
# This program is free software. You can redistribute it and/or modify
# it under the terms of the GNU General Public License as published by
# the Free Software Foundation; either version 2 or later of the GPL.
#
# $Id: proadd.php,v 1.2 2003/02/25 11:45:44 helix Exp $
#
######################################################################
...
if ($perm->have_perm("user_pending")) {
  ...
  if (isset($id)) {
    ...
    if (!$db->query("SELECT $columns FROM $tables WHERE $where")) {
	  ...
	  // If enterprise in table ask for product
      if ($db->next_record()) {
